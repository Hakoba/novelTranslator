...
> **Версия 0.0.3.** В магазинах расширений пока нет, ставится из исходников. Всё описанное ниже
> работает; чего не хватает — в разделе [«Планы»](#планы).

<p align="center">
  <img src="landing/img/overlay.png" width="840"
       alt="Пост на reddit: сложные слова подсвечены прямо в тексте, рядом карточка одного из них и панель со списком найденного" />
</p>
