...
Подойдёт любая страница с текстом — статья, документация, тред на Reddit, глава книги, — и только
на тех сайтах, которые вы разрешили сами.

> **Версия 0.0.4.** В магазинах расширений пока нет, ставится из исходников. Всё описанное ниже
> работает; чего не хватает — в разделе [«Планы»](#планы).

<p align="center">
  <img src="landing/img/overlay.png" width="840"
       alt="Пост на reddit: сложные слова подсвечены прямо в тексте, а в боковой панели — список найденного с переводами и уровнями" />
</p>
...
<p align="center">
  <img src="landing/img/dictionary.png" width="840"
       alt="Экран словаря: сохранённые слова с уровнем, предложением-контекстом и пояснением, поиск, фильтр по уровню и выгрузка в Anki" />
</p>

<p align="center">
  <img src="landing/img/training.png" width="840"
       alt="Тренировка: слово, предложение, из которого оно пришло, открытый перевод и кнопки «Знал / Не знал»" />
</p>
...
Из коробки это переводчик Microsoft Edge; [Яндекс.Словарь](https://yandex.ru/dev/dictionary/)
даёт полную статью с транскрипцией, если у вас уже есть его ключ (новых Яндекс не выдаёт);
[dictionaryapi.dev](https://dictionaryapi.dev/) отдаёт толкования без ключа. Фразы можно
...
2. Читаемый текст ищется по трём источникам в порядке убывания доверия: выбранная вами руками
   область, встроенное правило для сайта (их три: reddit, webnovel, royalroad) или скоринг
